<template>
  ...
  <section class="px-2 pt-32 bg-white md:px-0">
    ...
    >
      ...
      >
        Award winning software that will take your marketing game to the next
        level!
      </p>
      <div
      ...
      >
        <a
          href="#_"
          class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-primary rounded-md md:mb-0 hover:bg-red-800 md:w-auto"
        >
          Dowload It Free
          <svg
