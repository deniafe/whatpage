      ...
      <div class="flex flex-wrap items-center sm:-mx-3">
        <div class="w-full md:w-1/2 md:px-3">
          ...
          >
            ...
            >
              It's Never Been Easier To Reach Prospective Customers With
              <span class="text-black font-medium"> 98% Open Rate </span>

              And Promote Any Product Or Service To Over 2 Billion People.
            </p>
